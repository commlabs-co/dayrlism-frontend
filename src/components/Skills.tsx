            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {profile.techSkills.map((tech) => (
                  <span
                    key={tech}
                    className="rounded-full border border-slate-200 bg-white px-3 py-1 text-xs font-medium text-slate-600 dark:border-white/10 dark:bg-ink dark:text-slate-300"
                  >
                    {tech}
                  </span>
                ))}
